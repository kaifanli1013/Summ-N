...
if __name__ == '__main__':
    ...
    #         # Inference using the trained checkpoint
    #         stage_arg = getattr(args, f"stage{args.cur_stage}")
    #         stage_arg.trainer_output_folder = os.path.join(args.train.checkpoint_dir, f"stage{args.cur_stage}")
    ...
    # data_folder = "./output/AMI/stage_2"
    # cur_target = target_data
    # cur_hypo = "./output/AMI/stage_2"
    
    data_folder = "./output/AMI/stage_2"
    cur_target = target_data
    cur_hypo = load_split_aslist("./AMI", suffix='hypo')
